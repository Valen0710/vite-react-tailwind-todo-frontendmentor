...
//  { id: 2, title: "Go to ther gym",completed: false },
...
const App = () => {
  ...
  return (
    ...
    bg-gray-300 min-h-screen dark:bg-gray-900 dark:bg-[url('./assets/images/bg-mobile-dark.jpg')] transition-all duration-1000 
